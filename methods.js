...
let bankAccount = {
  ...
  deposit: function(ammount) {
    ...
    console.log (`Deposit Success! ${amount} deposited, $${this.balance} in account`)
...
bankAccount.owner = "Elijah"


// **** Problem 1 Tests ****
console.log('**** Problem 1 Tests ****');
console.log(`Good Day ${typeof bankAccount.owner}`);
console.log(`${bankAccount.createGreeting()} ${bankAccount.owner}  ${bankAccount.bankName}`);
